<template>
    <DashboardLayout>
        <form class="space-y-5 w-lg" @submit.prevent="submit">
            <div>
                <label for="name"
                    :class="['block mb-2 text-sm font-medium  dark:text-white', form.errors.email ? 'text-red-600' : 'text-gray-900']">
                    User Name</label>
                <div class="relative">
            ...
            <div>
                <label for="email"
                    :class="['block mb-2 text-sm font-medium  dark:text-white', form.errors.email ? 'text-red-600' : 'text-gray-900']">User
                    Email</label>
                <div class="relative">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
