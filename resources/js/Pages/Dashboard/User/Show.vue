        ...
        <div>
            ...
            <div class="relative">
                ...
                <input
                    ...
                    id="name"
                    v-model="form.name"
                    class="bg-gray-50 border-gray-300 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required
                />
            </div>
        </div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        >
            ...
            <tbody>
                ...
                <tr v-for="assign in completed_assigns" :key="assign.id">
                    <th
                        scope="row"
